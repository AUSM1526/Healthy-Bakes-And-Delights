...
import {registerUser,loginUser,logoutUser,refreshAccessToken,changePassword,updateName,updateAvatar, getUserDetails, addToCart, removeFromCart, viewCart,getOrderHistory, getOrdersByStatus, sendOtp, getAllAddresses} from "../controllers/user.controller.js";
...
userRouter.route("/get-all-addresses").get(verifyJWT,getAllAddresses);
