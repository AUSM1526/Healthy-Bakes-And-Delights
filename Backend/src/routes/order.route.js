...
import {placeSingleOrder, placeCartOrder, getAllOrders, updateOrderStatus, cancelOrder, confirmPaymentScreenshot, updatePaymentScreenshot, approveOrder, notApproveOrder} from "../controllers/order.controller.js";
...
orderRouter.route("/uploadPaymentScreenshot").post(verifyJWT, upload.single("screenshot"), confirmPaymentScreenshot);
