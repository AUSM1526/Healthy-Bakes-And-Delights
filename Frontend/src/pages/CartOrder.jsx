                        ...
                        <div className="space-y-4">
                            {products.map((product, index) => (
                                ...
                                <div className="flex-1 ml-4">
                                    <p className="text-[#4b2e1e] font-medium font-serif">{product.name}</p>
                                    <p className="text-sm text-gray-500">{product.subCategory!== "No SubCategory" && product.subCategory} {product.productType}</p>
                                    <p className="text-sm text-gray-500">Quantity: {product.quantity}</p>
                                </div>

                                {/* Price */}
                                <div className="text-[#4b2e1e] font-medium font-serif whitespace-nowrap">
